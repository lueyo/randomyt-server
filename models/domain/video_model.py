...
class VideoModel(BaseModel):
    ...
    posted_date: datetime = Field(..., description="Fecha de publicación del video en la base de datos")
    upload_date: datetime = Field(..., description="Fecha de subida del video")
    tags: List[str] = Field(default_factory=list)
    views: int = Field(..., le=2000, description="Número de visualizaciones del video, no puede ser superior a 2000")
